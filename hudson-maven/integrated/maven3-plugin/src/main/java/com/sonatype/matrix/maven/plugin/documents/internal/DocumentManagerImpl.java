...
import static com.sonatype.matrix.maven.model.config.DocumentStandardAttributeDTO.CREATED;
import static com.sonatype.matrix.maven.model.config.DocumentStandardAttributeDTO.CREATED_BY;
import static com.sonatype.matrix.maven.model.config.DocumentStandardAttributeDTO.UPDATED;
import static com.sonatype.matrix.maven.model.config.DocumentStandardAttributeDTO.UPDATED_BY;
