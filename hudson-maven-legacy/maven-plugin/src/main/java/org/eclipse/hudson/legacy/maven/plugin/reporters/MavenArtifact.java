    ...
    public void archive(MavenBuildProxy build, File file, BuildListener listener) throws IOException, InterruptedException {
        if (build.isArchivingDisabled()) {
            ...
            java.util.concurrent.ExecutionException: java.io.IOException: Archived artifact is missing: /files/hudson/server/jobs/glassfish-v3/modules/org.glassfish.build$maven-glassfish-extension/builds/2008-04-02_10-17-15/archive/org.glassfish.build/maven-glassfish-extension/1.0-SNAPSHOT/maven-glassfish-extension-1.0-SNAPSHOT.jar
                    ...
                    at org.eclipse.hudson.legacy.maven.plugin.MavenBuilder.call(MavenBuilder.java:140)
                    at org.eclipse.hudson.legacy.maven.plugin.MavenModuleSetBuild$Builder.call(MavenModuleSetBuild.java:476)
                    at org.eclipse.hudson.legacy.maven.plugin.MavenModuleSetBuild$Builder.call(MavenModuleSetBuild.java:422)
            ...
            Caused by: java.io.IOException: Archived artifact is missing: /files/hudson/server/jobs/glassfish-v3/modules/org.glassfish.build$maven-glassfish-extension/builds/2008-04-02_10-17-15/archive/org.glassfish.build/maven-glassfish-extension/1.0-SNAPSHOT/maven-glassfish-extension-1.0-SNAPSHOT.jar
                    at org.eclipse.hudson.legacy.maven.plugin.reporters.MavenArtifact.getFile(MavenArtifact.java:147)
                    at org.eclipse.hudson.legacy.maven.plugin.reporters.MavenArtifact.toArtifact(MavenArtifact.java:126)
                    at org.eclipse.hudson.legacy.maven.plugin.reporters.MavenArtifactRecord.install(MavenArtifactRecord.java:115)
                    at org.eclipse.hudson.legacy.maven.plugin.reporters.MavenArtifactArchiver$1.call(MavenArtifactArchiver.java:81)
                    at org.eclipse.hudson.legacy.maven.plugin.reporters.MavenArtifactArchiver$1.call(MavenArtifactArchiver.java:71)
                    at org.eclipse.hudson.legacy.maven.plugin.MavenBuild$ProxyImpl.execute(MavenBuild.java:255)
                    at org.eclipse.hudson.legacy.maven.plugin.MavenBuildProxy$Filter$AsyncInvoker.call(MavenBuildProxy.java:177)
                    at hudson.remoting.UserRequest.perform(UserRequest.java:69)
                    at hudson.remoting.UserRequest.perform(UserRequest.java:23)
                    at hudson.remoting.Request$2.run(Request.java:200)
